                        ...
                        <div class="px-50 py-50 sm:px-20 sm:py-20 bg-white shadow-4 rounded-4">
                            <div class="row y-gap-20">
                                <div class="col-12">
                                    ...
                                    <p class="mt-10">Don't have an account yet? <a href="/gotrip/user/signin.php" class="text-blue-1">Sign up for free</a></p>
                                </div>
                                <div class="">
                                ...
                                <form action="/gotrip/actions/login_core.php" method="POST">
                                    <div class="col-12">
                                    ...
                                    <div class="col-12 my-3">
                                        <a href="/gotrip/user/forgotPassword.php" class="text-14 fw-500 text-blue-1 underline">Forgot your
                                            password?</a>
                                    </div>

                                    <div class="col-12">
                                        <button class="button py-20 -dark-1 bg-blue-1 text-white w-1/1">
                            ...
                            <div class="row y-gap-20 pt-30">
                                ...
                                <div class="col-12">
                                    <div class="text-center px-30">By creating an account, you agree to our Terms of
                                        Service and Privacy Statement.</div>
                                </div>
                            </div>
                        </div>
                    </div>
