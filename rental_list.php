        ...
        <div class="row">
          <div class="col-12">
            <div class="text-center">
              <h1 class="text-30 fw-600">Rental in London</h1>
            </div>
                ...
                <div class="border-top-light pt-20">
                  <div class="row x-gap-20 y-gap-20">
                    <div class="col-md-auto">
                      ...
                      <div class="cardImage ratio ratio-1:1 w-250 md:w-1/1 rounded-4">
                        <div class="cardImage__content">
                          ...
                          <img class="rounded-4 col-12 js-lazy" src="#" data-src="img/lists/rental/1/1.png" alt="image">
                    ...
                    <div class="col-md">
                      <div class="d-flex flex-column h-full justify-between">
                        <div class="">
                          ...
                          <h3 class="text-18 lh-16 fw-500">Luxury New Apartment With Private<br> Garden</h3>
                    ...
                    <div class="col-md-auto text-right md:text-left">
                      ...
                      <div class="text-14 text-light-1 mt-40 md:mt-20">From</div>
                        ...
                        <div class="cardImage__content">
                          ...
                          <div class="cardImage-slider rounded-4 overflow-hidden js-cardImage-slider">
                            <div class="swiper-wrapper">
                              ...
                              <div class="swiper-slide">
                                <img class="col-12 js-lazy" src="#" data-src="img/lists/rental/1/2.png" alt="image">
                              </div>

                              <div class="swiper-slide">
                                <img class="col-12 js-lazy" src="#" data-src="img/lists/rental/1/3.png" alt="image">
                              </div>

                              <div class="swiper-slide">
                                <img class="col-12 js-lazy" src="#" data-src="img/lists/rental/1/4.png" alt="image">
                              </div>
                    ...
                    <div class="col-md-auto">
                      ...
                      <div class="cardImage ratio ratio-1:1 w-250 md:w-1/1 rounded-4">
                        <div class="cardImage__content">
                          ...
                          <img class="rounded-4 col-12 js-lazy" src="#" data-src="img/lists/rental/1/3.png" alt="image">
                    ...
                    <div class="col-md-auto">
                      ...
                      <div class="cardImage ratio ratio-1:1 w-250 md:w-1/1 rounded-4">
                        <div class="cardImage__content">
                          ...
                          <img class="rounded-4 col-12 js-lazy" src="#" data-src="img/lists/rental/1/4.png" alt="image">
                    ...
                    <div class="col-md-auto">
                      ...
                      <div class="cardImage ratio ratio-1:1 w-250 md:w-1/1 rounded-4">
                        <div class="cardImage__content">
                          ...
                          <img class="rounded-4 col-12 js-lazy" src="#" data-src="img/lists/rental/1/5.png" alt="image">
