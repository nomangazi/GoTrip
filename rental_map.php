      ...
      <div class="halfMap__content">
        ...
        <div class="row x-gap-10 y-gap-10 pt-20 pb-20">
          <div class="col-auto">
            ...
            <div class="dropdown js-dropdown js-placeType-active">
              <div class="dropdown__button d-flex items-center text-14 rounded-100 border-light px-15 h-34" data-el-toggle=".js-placeType-toggle" data-el-toggle-active=".js-placeType-active">
                <span class="js-dropdown-title">Type of Place</span>
                <i class="icon icon-chevron-sm-down text-7 ml-10"></i>
              </div>

              <div class="toggle-element -dropdown js-click-dropdown js-placeType-toggle">
        ...
        <div class="row y-gap-10 justify-between items-center pb-20">
          <div class="col-auto">
              ...
              <div class="row x-gap-20 y-gap-20">
                <div class="col-md-auto">
                  ...
                  <div class="cardImage ratio ratio-1:1 w-200 md:w-1/1 rounded-4">
                    <div class="cardImage__content">
                      ...
                      <img class="rounded-4 col-12 js-lazy" src="#" data-src="img/lists/rental/3/1.png" alt="image">
                ...
                <div class="col-md">
                  <div class="d-flex flex-column h-full justify-between">
                    <div class="">
                      <p class="text-14 lh-14 mb-5">Westminster Borough, London</p>
                ...
                <div class="col-md-auto text-right md:text-left">
                  ...
                  <div class="text-14 text-light-1 mt-20 md:mt-20">From</div>
                  <div class="text-22 lh-12 fw-600 mt-5">US$72</div>
                  <div class="text-14 text-light-1 mt-5">per adult</div>


                  <a href="#" class="button py-10 px-20 -dark-1 bg-blue-1 text-white mt-10">
                ...
                <div class="col-md-auto">
                  ...
                  <div class="cardImage ratio ratio-1:1 w-200 md:w-1/1 rounded-4">
                    <div class="cardImage__content">
                      ...
                      <img class="rounded-4 col-12 js-lazy" src="#" data-src="img/lists/rental/3/2.png" alt="image">
                ...
                <div class="col-md-auto">
                  ...
                  <div class="cardImage ratio ratio-1:1 w-200 md:w-1/1 rounded-4">
                    <div class="cardImage__content">
                      ...
                      <img class="rounded-4 col-12 js-lazy" src="#" data-src="img/lists/rental/3/3.png" alt="image">
