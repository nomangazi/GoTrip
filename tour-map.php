...
<body>
  ...
  <main>
    ...
    <header class="header bg-dark-1 text-white">
      <?= HeaderMeta::getMenu(); ?>
    </header>
          ...
          <div class="button-grid items-center">
            ...
            <div class="searchMenu-loc pr-30 pl-20 lg:py-20 lg:px-0 js-form-dd js-liverSearch">
              ...
              <div class="d-flex" data-x-dd-click="searchMenu-loc">
                ...
                <div class="ml-10">
                  <h4 class="text-15 fw-500 ls-2 lh-16">Destinations</h4>
            ...
            <div class="searchMenu-date px-30 lg:py-20 lg:px-0 -left js-form-dd js-calendar">
        ...
        <div class="row x-gap-10 y-gap-10 pt-20">
          ...
          <div class="col-auto">
            ...
            <div class="dropdown js-dropdown js-duration-active">
              <div class="dropdown__button d-flex items-center text-14 rounded-100 border-light px-15 h-34" data-el-toggle=".js-duration-toggle" data-el-toggle-active=".js-duration-active">
                <span class="js-dropdown-title">Duration</span>
                <i class="icon icon-chevron-sm-down text-7 ml-10"></i>
              </div>

              <div class="toggle-element -dropdown js-click-dropdown js-duration-toggle">
                <div class="text-15 y-gap-15 js-dropdown-list">

                  <div><a href="#" class="d-block js-dropdown-link">1 week</a></div>

                  <div><a href="#" class="d-block js-dropdown-link">2 weeks</a></div>

                  <div><a href="#" class="d-block js-dropdown-link">3 weeks</a></div>

                  <div><a href="#" class="d-block js-dropdown-link">1 month</a></div>
          ...
          <div class="col-auto">
            ...
            <div class="dropdown js-dropdown js-language-active">
              <div class="dropdown__button d-flex items-center text-14 rounded-100 border-light px-15 h-34" data-el-toggle=".js-language-toggle" data-el-toggle-active=".js-language-active">
                <span class="js-dropdown-title">Language</span>
                <i class="icon icon-chevron-sm-down text-7 ml-10"></i>
              </div>

              <div class="toggle-element -dropdown js-click-dropdown js-language-toggle">
                <div class="text-15 y-gap-15 js-dropdown-list">

                  <div><a href="#" class="d-block js-dropdown-link">English</a></div>

                  <div><a href="#" class="d-block js-dropdown-link">Italian</a></div>

                  <div><a href="#" class="d-block js-dropdown-link">Deutsch</a></div>

                  <div><a href="#" class="d-block js-dropdown-link">Turkish</a></div>
            ...
            <div class="border-top-light pt-20">
              <div class="row x-gap-20 y-gap-20">
                <div class="col-md-auto">
                  ...
                  <div class="cardImage ratio ratio-1:1 w-200 md:w-1/1 rounded-4">
                    <div class="cardImage__content">
                      ...
                      <img class="rounded-4 col-12 js-lazy" src="#" data-src="img/lists/tour/1/1.png" alt="image">
                ...
                <div class="col-md">
                  ...
                  <h3 class="text-16 lh-16 fw-500">Leeds Castle, Cliffs of Dover and Canterbury Day Trip from London with Guided Cathedral Tour</h3>
                ...
                <div class="col-md-auto text-right md:text-left">
                  ...
                  <div class="text-14 text-light-1 mt-24 md:mt-20">From</div>
                  <div class="text-22 lh-12 fw-600">US$72</div>
                  <div class="text-14 text-light-1">per adult</div>


                  <a href="#" class="button py-10 px-24 -dark-1 bg-blue-1 text-white mt-15">
                    ...
                    <div class="cardImage__content">
                      ...
                      <div class="cardImage-slider rounded-4 overflow-hidden js-cardImage-slider">
                        <div class="swiper-wrapper">
                          ...
                          <div class="swiper-slide">
                            <img class="col-12 js-lazy" src="#" data-src="img/lists/tour/1/2.png" alt="image">
                          </div>

                          <div class="swiper-slide">
                            <img class="col-12 js-lazy" src="#" data-src="img/lists/tour/1/3.png" alt="image">
                          </div>

                          <div class="swiper-slide">
                            <img class="col-12 js-lazy" src="#" data-src="img/lists/tour/1/4.png" alt="image">
                          </div>
                ...
                <div class="col-md-auto">
                  ...
                  <div class="cardImage ratio ratio-1:1 w-200 md:w-1/1 rounded-4">
                    <div class="cardImage__content">
                      ...
                      <img class="rounded-4 col-12 js-lazy" src="#" data-src="img/lists/tour/1/3.png" alt="image">
